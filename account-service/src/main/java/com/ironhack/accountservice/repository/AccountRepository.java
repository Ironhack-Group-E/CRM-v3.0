...
public interface AccountRepository extends JpaRepository<Account, Integer> {
    ...
    @Query(value = "SELECT AVG(count_id) FROM (SELECT COUNT(account_id) count_id FROM opportunity " +
    ...
    @Query(value = "SELECT AVG(o.count_id) FROM " +
            ...
            "FROM (SELECT COUNT(account_id) count_id FROM opportunity " +
    ...
    @Query(value = "SELECT MAX(count_id) FROM (SELECT COUNT(account_id) count_id FROM opportunity " +
            "GROUP BY account_id) AS opp_list", nativeQuery = true)
    public Integer maxOfOpportunitiesOnAccounts();

    @Query(value = "SELECT MIN(count_id) FROM (SELECT COUNT(account_id) count_id FROM opportunity " +
            "GROUP BY account_id) AS opp_list", nativeQuery = true)
